...
namespace Ragnarok.Migrations
{
    ...
    [Migration("20210418205424_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ragnarok.Models.ManyToMany.SalesItem", b =>
                {
                    b.Property<int>("StockId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ragnarok.Models.Payment.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ragnarok.Models.SaleBox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("RegisterSalesId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("RegisterSalesId");

                    b.ToTable("TB_SaleBox");
                });

            modelBuilder.Entity("Ragnarok.Models.SalesOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ragnarok.Models.Payment.AfterPaid", b =>
                {
                    b.HasBaseType("Ragnarok.Models.Payment.Payment");
            ...
            modelBuilder.Entity("Ragnarok.Models.Payment.Credit", b =>
                {
                    b.HasBaseType("Ragnarok.Models.Payment.Payment");
            ...
            modelBuilder.Entity("Ragnarok.Models.Payment.Debit", b =>
                {
                    b.HasBaseType("Ragnarok.Models.Payment.Payment");
            ...
            modelBuilder.Entity("Ragnarok.Models.Payment.Money", b =>
                {
                    b.HasBaseType("Ragnarok.Models.Payment.Payment");

                    b.Property<double>("GetMoney")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Ragnarok.Models.Payment.Ticket", b =>
                {
                    b.HasBaseType("Ragnarok.Models.Payment.Payment");
            ...
            modelBuilder.Entity("Ragnarok.Models.ManyToMany.SalesItem", b =>
                {
                    b.HasOne("Ragnarok.Models.SalesOrder", "SalesOrder")
                        .WithMany("SalesItem")
            ...
            modelBuilder.Entity("Ragnarok.Models.SaleBox", b =>
                {
                    b.HasOne("Ragnarok.Models.Employee", "RegisterSales")
                        .WithMany()
                        .HasForeignKey("RegisterSalesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Ragnarok.Models.SalesOrder", b =>
                {
                    ...
                    b.HasOne("Ragnarok.Models.Payment.Payment", "Payment")
                        .WithOne("SalesOrder")
                        .HasForeignKey("Ragnarok.Models.SalesOrder", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ragnarok.Models.SaleBox", "SaleBox")
                        .WithMany("SalesOrders")
                        .HasForeignKey("SaleBoxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
