...
namespace Ragnarok.Services.Report.SpreadSheetCreator
{
    ...
    {
        public static string SheetsClient(List<Client> list, string path, string fileName)
        {
            try
            {
                using (var workbook = new XLWorkbook(path))
                {
                    ...
                    foreach (var obj in list)
                    {
                        ...
                        if (obj is ClientPhysical)
                        {
                            ClientPhysical client = (ClientPhysical)obj;
                        ...
                        {
                            ClientJuridical client = (ClientJuridical)obj;
